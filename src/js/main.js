...
const load = () =>{
  ...
  ['みゃー……','うにゃ……','にゃーん……','にゃーん！','にゃ～ん！','にゃ～ん?','にゃんにゃん！','うにゃー','みゃぉー','にゃー','にゃーぉ','ごろにゃー','うみゃう','みゃー','なーご','ふかーっ！','ごろごろ……','ふしゃーっ！','うにゃうにゃ','にゃぉーん','にゃーん！にゃーん！にゃーん！'].sort(()=>{return Math.random()-.5}).forEach(renderMeow);
